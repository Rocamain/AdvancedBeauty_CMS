...
export interface ApiFaresFares extends Schema.SingleType {
  collectionName: 'fareses';
  info: {
    singularName: 'fares';
    pluralName: 'fareses';
    displayName: 'Fares';
...
export interface ApiIllaIlla extends Schema.SingleType {
  collectionName: 'illas';
  info: {
    singularName: 'illa';
    pluralName: 'illas';
    displayName: 'Illa';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::illa.illa', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::illa.illa', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiPalmaPalma extends Schema.SingleType {
  collectionName: 'palmas';
  info: {
    singularName: 'palma';
    pluralName: 'palmas';
    displayName: 'Palma';
...
export interface ApiPromotionsPromotions extends Schema.SingleType {
  collectionName: 'promotionses';
  info: {
    singularName: 'promotions';
    pluralName: 'promotionses';
...
export interface ApiSectionIdSectionId extends Schema.CollectionType {
  collectionName: 'section_ids';
  info: {
    singularName: 'section-id';
    pluralName: 'section-ids';
    displayName: 'link';
    description: '';
  };
  options: {
...
export interface ApiServicesAndFareServicesAndFare extends Schema.SingleType {
  collectionName: 'services_and_fares';
  info: {
    singularName: 'services-and-fare';
    pluralName: 'services-and-fares';
    displayName: 'Services and fare';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiTuroTuro extends Schema.SingleType {
  collectionName: 'turos';
  info: {
    singularName: 'turo';
    pluralName: 'turos';
    displayName: 'Turo';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::turo.turo', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::turo.turo', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::fares.fares': ApiFaresFares;
      'api::home.home': ApiHomeHome;
      'api::illa.illa': ApiIllaIlla;
      'api::logo.logo': ApiLogoLogo;
      'api::palma.palma': ApiPalmaPalma;
      'api::promotions.promotions': ApiPromotionsPromotions;
      'api::section-id.section-id': ApiSectionIdSectionId;
      'api::services-and-fare.services-and-fare': ApiServicesAndFareServicesAndFare;
      'api::turo.turo': ApiTuroTuro;
    }
  }
}
