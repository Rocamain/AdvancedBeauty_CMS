...
- Create your own navigation by creating routes and links.
- Select the components and reorganize them the way you want, thank to use of dynamic components
- Add content to each component.

### Goals

My main goal was to learn and implement a CMS that will help to the user manage and reorganize the content of the front end. Giving them independence and flexibility from the user to the code. Also adding the possibility to increase the number of new components and features to CMS in the future.
...
- Reconfigure and rename the the components and end point of the api in more generic way.
